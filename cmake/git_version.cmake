...
set(VERSION_FILE "#ifndef ${ARGS_DPREFIX}_VERSION_H" "#define ${ARGS_DPREFIX}_VERSION_H"
...
if(ARGS_WITH_DIFF)
  ...
  if(GIT_DIFF)
    ...
    file(WRITE ${ARGS_BINARY_DIR}/git_version/diff.cpp.new "const char* ${ARGS_DIFF_VAR} = \"\";\n")
  endif()
  execute_process(
    COMMAND ${CMAKE_COMMAND} -E copy_if_different ${ARGS_BINARY_DIR}/git_version/diff.cpp.new
            ${ARGS_BINARY_DIR}/git_version/diff.cpp
  )
endif()
...
execute_process(
  COMMAND ${CMAKE_COMMAND} -E copy_if_different ${ARGS_BINARY_DIR}/git_version/version.h.new
          ${ARGS_BINARY_DIR}/git_version/version.h
)
