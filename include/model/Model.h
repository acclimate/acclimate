...
class Model {
  ...
  public:
    ...
    std::vector<std::unique_ptr<Identifier<ModelVariant>>> identifiers;
  ...
  public:
    ...
    Identifier<ModelVariant>* add_identifier(std::string name);
    ...
    Identifier<ModelVariant>* find_identifier(const std::string &name) const;
    ...
    Firm <ModelVariant>* find_firm(Identifier<ModelVariant> *identifier) const;
    Firm <ModelVariant> *find_firm(const std::string &identifier_name) const;
