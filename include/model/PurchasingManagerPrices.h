...
class PurchasingManagerPrices : public PurchasingManager<ModelVariant> {
  ...
  public:
    inline FloatType optimized_value() const {
  ...
  protected:
    ...
    inline FloatType scaled_D_r(FloatType D_r, const BusinessConnection<ModelVariant>* bc) const;
    inline FloatType unscaled_D_r(FloatType x, const BusinessConnection<ModelVariant>* bc) const;
    ...
    FloatType n_r(FloatType D_r, const BusinessConnection<ModelVariant>* business_connection) const;
    FloatType estimate_production_extension_penalty(const BusinessConnection<ModelVariant>* bc, FloatType production_quantity_X) const;
    ...
    FloatType estimate_marginal_production_extension_penalty(const BusinessConnection<ModelVariant>* bc, FloatType production_quantity_X) const;
    FloatType expected_average_price_E_n_r(FloatType D_r, const BusinessConnection<ModelVariant>* business_connection) const;
    FloatType transport_penalty(FloatType D_r, const BusinessConnection<ModelVariant>* business_connection) const;
    FloatType calc_n_co(FloatType n_bar_min, FloatType D_r_min, const BusinessConnection<ModelVariant>* business_connection) const;
    FloatType grad_n_r(FloatType D_r, const BusinessConnection<ModelVariant>* business_connection) const;
    FloatType grad_expected_average_price_E_n_r(FloatType D_r, const BusinessConnection<ModelVariant>* business_connection) const;
    FloatType partial_D_r_transport_penalty(FloatType D_r, const BusinessConnection<ModelVariant>* business_connection) const;
