...
class CapacityManagerPrices : public CapacityManager {
  public:
    using CapacityManager::calc_possible_and_desired_production;
    using CapacityManager::firm;
    using CapacityManager::id;
    using CapacityManager::model;
    using CapacityManager::possible_overcapacity_ratio_beta;

  private:
    const Flow get_possible_production_X_hat_intern(bool consider_transport_in_production_costs, bool estimate) const;

  public:
    CapacityManagerPrices(Firm* firm_p, Ratio possible_overcapacity_ratio_beta_p);
